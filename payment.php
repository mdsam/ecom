...
<form align="center" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
  ...
  <input type="hidden" name="return" value="http://localhost/projects/ecom/paypal_success.php" />
  <input type="hidden" name="cancel_return" value="http://localhost/projects/ecom/paypal_cancel.php" />
